...
"""
Telegram бот "Блинная башня" для работы с веб-приложением на GitHub Pages
"""
...
GITHUB_PAGES_URL = "https://spartakbudaev.github.io/blins/"  # URL вашего приложения на GitHub Pages
...
def main():
    ...
    print("=" * 50)
    print("Запуск Telegram бота 'Блинная башня' с веб-приложением на GitHub Pages")
    print("=" * 50)
    print(f"\nВеб-приложение доступно по адресу: {GITHUB_PAGES_URL}")
