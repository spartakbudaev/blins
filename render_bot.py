...
"""
Telegram бот "Блинная башня" для работы с веб-приложением на Render
"""
...
def main():
    ...
    if not RENDER_APP_URL:
        logger.error("URL приложения Render не найден в переменных окружения!")
        logger.info("Используем локальный URL: http://localhost:8080")
        print("⚠️ URL приложения Render не указан в .env файле!")
        print("⚠️ Укажите RENDER_APP_URL в файле .env после деплоя на Render.")
        print("⚠️ Пока используется локальный URL: http://localhost:8080")
    
    # Выводим информацию о запуске
    print("=" * 50)
    print("Запуск Telegram бота 'Блинная башня' с веб-приложением на Render")
    print("=" * 50)
    if RENDER_APP_URL:
        print(f"\nВеб-приложение доступно по адресу: {RENDER_APP_URL}")
